...
AS $$
DECLARE
  project_url TEXT := 'http://20.218.131.251:3000';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.ewogICJyb2xlIjogInNlcnZpY2Vfcm9sZSIsCiAgImlzcyI6ICJzdXBhYmFzZSIsCiAgImlhdCI6IDE3MTg3NDQ0MDAsCiAgImV4cCI6IDE4NzY1MTA4MDAKfQ.JSlxllsOu1vZ6r_4lKaI2xsuq8gJe5NGiOH3TEpADKs';
