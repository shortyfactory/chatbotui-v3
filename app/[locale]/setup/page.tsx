...
export default function SetupPage() {
  ...
  const handleSaveSetupSetting = async () => {
    ...
    const updateProfilePayload: TablesUpdate<"profiles"> = {
      ...
      display_name: user?.email ? user.email.substring(0, 100).trim() : generateUniqueUsername(),
      username: username && username.length ? username : generateUniqueUsername(),
      ...
      case 1:
        return (
          <StepContainer
            ...
            stepNum={currentStep}
            stepTitle="Welcome to AI Chatbot"
