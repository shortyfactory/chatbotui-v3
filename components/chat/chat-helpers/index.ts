...
export const handleImportChatHistory = async (
  chats: {
    name: string
    temperature: number
    prompt: string
  ...
  for await (const chat of chats) {
    ...
    const messages: TablesInsert<"messages">[] = chat.messages.map(msg => {
      return {
...
export const handleCreateChat = async (
  ...
  selectedPreset: Tables<"presets" | "presets_library">,
  newMessageFiles: ChatFile[],
