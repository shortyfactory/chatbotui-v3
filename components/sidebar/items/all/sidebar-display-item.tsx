        ...
        <div
          ...
          onClick={() => {
            ...
            if (contentType === "presets") {
              const presetItem = item as Tables<"presets">
              ...
              setSelectedTools([])
              setChatSettings({
                model: presetItem.model as LLMID,
                prompt: presetItem.prompt,
                temperature: presetItem.temperature,
                contextLength: presetItem.context_length,
                includeProfileContext: presetItem.include_profile_context,
                includeWorkspaceInstructions:
                  presetItem.include_workspace_instructions,
                embeddingsProvider: presetItem.embeddings_provider as
                  | "openai"
                  | "local"
              })
            }
