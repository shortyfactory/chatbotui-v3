...
export const Message: FC<MessageProps> = ({
  ...
  const [chatPreset, setChatPreset] = useState<Tables<"presets" | "presets_library"> | null>(null)
  ...
  useEffect(() => {
    if (selectedChat) {
      const allPresets = [...presets, ...presetsLibrary];
      const chatPreset = allPresets.find(preset => preset.id === selectedChat?.preset_id);
      setChatPreset(chatPreset || null);
    }
  }, [selectedChat])
                ...
                {message.role === "assistant"
                  ? message.assistant_id
                    ...
                    : selectedAssistant
                      ...
                      : `${MODEL_DATA?.modelName}${chatPreset && chatPreset?.name ? ` - ${chatPreset?.name}` : ""}`
