...
interface ChatbotUIContext {
  ...
  presetsLibrary: Tables<"presets_library">[]
  setPresetsLibrary: Dispatch<SetStateAction<Tables<"presets_library">[]>>
  prompts: Tables<"prompts">[]
  setPrompts: Dispatch<SetStateAction<Tables<"prompts">[]>>
  promptsLibrary: (Tables<"prompts_library"> & { user_id?: string; folder_id?: number })[]
  setPromptsLibrary: Dispatch<SetStateAction<(Tables<"prompts_library"> & { user_id?: string; folder_id?: number })[]>>
  tools: Tables<"tools">[]
  ...
  // PRESET STORE
  selectedPreset: Tables<"presets" | "presets_library"> | null
  setSelectedPreset: Dispatch<SetStateAction<Tables<"presets" | "presets_library"> | null>>
  ...
  selectedPrompt: (Tables<"prompts" | "prompts_library"> & { user_id?: string; folder_id?: number }) | null
  setSelectedPrompt: Dispatch<SetStateAction<(Tables<"prompts" | "prompts_library"> & { user_id?: string; folder_id?: number }) | null>>
  slashCommand: string
